...
if TYPE_CHECKING:
    ...
    # KD fork: SSDP type-checking import removed
...
class HttpSrv(object):
    ...
    def __init__(self, broker: "BrokerCli", nid: Optional[int]) -> None:
        ...
        self.nm = NetMap([], [])
        # KD fork: SSDP responder removed
        ...
        self.iiam = '<img src="%s.kpr/w/iiam.gif?cache=i" />' % (self.args.SRS,)
        ...
        # KD fork: Metrics(self) removed (Prometheus endpoint disabled)
        self.nreq = 0
        self.nsus = 0
        self.nban = 0
        ...
        # KD fork: SSDP responder block removed
