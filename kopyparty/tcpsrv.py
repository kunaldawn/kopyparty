...
class TcpSrv(object):
    ...
    def __init__(self, hub: "SvcHub"):
        ...
        # KD fork: QR code printing removed (qrkode module deleted)
    ...
    def _distribute_netdevs(self):
        ...
        # KD fork: zeroconf + sftp/ftp/tftp restart hooks removed
    ...
    # KD fork: _qr / _qr2file / _h2i methods removed (qrkode module deleted)
