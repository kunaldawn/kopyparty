...
def add_ui(ap, retry: int):
    ...
    ap2.add_argument("--kd-arch", metavar="TXT", type=u, default="Data", help="KD fork: archive subtype name rendered in the themed header and footer (e.g. 'Data', 'PDF', 'Audio')")
